...
/**
 * @file
 * Contains \Drupal\varnish_purge\Form\VarnishPurge
*/
 ...
 */
class VarnishPurge extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'varnish_purge_varnish_purge_form';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $values = $form_state->getValue('paths');
    $submitted_paths = $values['path'];
    $messages = varnish_purge_clear_cache($submitted_paths);
